 ...
 * @version 0.1
 *
 * @file Contains CMUmobileWifiManager. This class provides an BroadcastReceiver that notifies of important wifi events
 * 
 */
 ...
 */
public class CMUmobileWifiManager {
	...
	private CMUmobileWifiChangeListener listener;
	...
	public void close (Context c) {
		...
		if (wifiCurrentAP != null) {
			...
			if (connectionTime > CMUmobileWifiManager.MINIMUM_CONNEXION_TIME) {
    ...
    public void setOnWifiChangeListener (CMUmobileWifiChangeListener listener) {
        ...
        public void onReceive(Context c, Intent i) {
        	...
        	switch (newState) {
        		case WifiManager.WIFI_STATE_DISABLED:
    				if (wifiCurrentAP != null) {
    					long wifiCurrentAPEnd = System.currentTimeMillis();
    					if ((wifiCurrentAPEnd - wifiCurrentAPStart) > CMUmobileWifiManager.MINIMUM_CONNEXION_TIME) {
